<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="homeplan.aspx.cs" Inherits="ISPDEMO.homeplan" ClientIDMode="Static" %>
    ...
    <script src="Bootstrap/js/bootstrap.min.js"></script>
     ...
     <script>
        $(document).ready(function() {
            $('#HomePlan1').prepend($("<thead></thead>").append($("#HomePlan1").find("tr:first"))).DataTable();
            $("#HomePlan1").addClass("table table-striped table-light table-bordered table-hover").DataTable();
        });
        $('#HomePlan1 tr').append('<td>new</td>').addClass("btn");
    </script>
    <style>
        hr{
    height:10px ;
...
<p style="text-align: center; font-size: 50px; ">
        <i class="fas fa-home" style="color:#067980;"></i> Home Plans!</p>
<hr/>
    ...
    <div>
        <div class="table-wrapper-scroll-y">
         <br />
            <asp:GridView ID="HomePlan1" AutoGenerateColumns="false" runat="server"><Columns>
